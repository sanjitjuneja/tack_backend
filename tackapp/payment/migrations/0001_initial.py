    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_name', models.CharField(choices=[('stripe', 'Stripe'), ('dwolla', 'Dwolla')], max_length=10)),
                ('action_type', models.CharField(choices=[('deposit', 'Deposit'), ('withdraw', 'Withdraw')], max_length=10)),
